...
import com.github.damdev.increase.bookkeeper.increasebookkeeper.algebras.{ClientAlg, FileImportAlg, FileProcessorAlg, PaymentAlg}
import com.github.damdev.increase.bookkeeper.increasebookkeeper.algebras.impl._
import com.github.damdev.increase.bookkeeper.increasebookkeeper.config.ConfigFactory
import com.github.damdev.increase.bookkeeper.increasebookkeeper.db.impl.PaymentDBImpl
import com.github.damdev.increase.bookkeeper.increasebookkeeper.db.{DBTransactor, PaymentDBAlg}
import doobie._
import fs2.Stream
